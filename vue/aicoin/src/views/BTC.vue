  ...
  <div>
    <div class="crumbs">
      <el-breadcrumb>
        ...
        <el-breadcrumb-item>比特币</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <el-row :gutter="20">
      <el-col :span="8">
      ...
      <el-col :span="8">
        <el-card shadow="hover">
          ...
          <!-- <div class="echarts1" ref="echartContainer1"></div> -->
          看多<el-progress :percentage="50.01" color="#42b983"></el-progress>
          看空<el-progress :percentage="49.99" color="#D41530"></el-progress>
        </el-card>
      </el-col>
    </el-row>
  </div>
