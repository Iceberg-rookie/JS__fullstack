    ...
    <div>
        <div class="crumbs">
          <el-breadcrumb>
            ...
            <el-breadcrumb-item>交易策略</el-breadcrumb-item>
          </el-breadcrumb>
        </div>
        <div class="container">
          ...
          <!-- 创建弹出框 -->
          <el-dialog title="创建新策略" v-model="dialogFormVisible">
            <el-form :model="form">
              <el-form-item label="参数A" :label-width="formLabelWidth">
                <el-select v-model="form.a" placeholder="请选择参数">
                  <el-option label="XXX" value="XXX"></el-option>
                  <el-option label="XXXX" value="XXXX"></el-option>
                </el-select>
              </el-form-item>
              <el-form-item label="参数B" :label-width="formLabelWidth">
                <el-select v-model="form.b" placeholder="请选择参数">
                  <el-option label="XXX" value="XXX"></el-option>
                  <el-option label="XXXX" value="XXXX"></el-option>
                </el-select>
              </el-form-item>
              <el-form-item label="参数C" :label-width="formLabelWidth">
                <el-select v-model="form.c" placeholder="请选择参数">
                  <el-option label="XXX" value="XXX"></el-option>
                  <el-option label="XXXX" value="XXXX"></el-option>
                </el-select>
              </el-form-item>
